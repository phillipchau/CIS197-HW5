  ...
  return (
    <>
      <div className="form-group">
        <label htmlFor="image" style={{ fontSize: 18 }}>Image</label>
      ...
      <div className="form-group" style={{ marginTop: 40, marginBottom: 40 }}>
        <label htmlFor="description" style={{ fontSize: 18 }}>Description</label>
      ...
      <button id="cancelbutton" type="button" className="btn btn-danger" onClick={submit}>Cancel</button>
    </>
  )
}
